                ...
                try {
                    ...
                    if (totalCount === 0) {
                        ...
                        return JSON.stringify({
                            ...
                            message:
                                "The inventory database appears to be empty",
                            count: 0,
                        })
                    }
                    ...
                    console.log(
                        `Vector search returned ${result.length} results`
                    )
                    ...
                    if (result.length === 0) {
                        ...
                        const textResults = await collection
                            .find({
                                $or: [
                                    ...
                                    }, // Case-insensitive search in categories
                                    {
                                        embedding_text: {
                                            $regex: query,
                                            $options: "i",
                                        },
                                    }, // Case-insensitive search in embedding text
                                ],
                            })
                            .limit(n)
                        ...
                        console.log(
                            `Text search returned ${textResults.length} results`
                        )
